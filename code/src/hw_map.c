...
void HW_Init_GPIO(void)
{
    ...
    LL_GPIO_SetAFPin_0_7(SPI_CJ125_SCK_PORT, SPI_CJ125_SCK_PIN, LL_GPIO_AF_5);
    ...
    LL_GPIO_SetPinMode(SPI_CJ125_MISO_PORT, SPI_CJ125_MISO_PIN,
        LL_GPIO_MODE_ALTERNATE);
    LL_GPIO_SetAFPin_0_7(SPI_CJ125_MISO_PORT, SPI_CJ125_MISO_PIN, LL_GPIO_AF_5);
    ...
    LL_GPIO_SetPinMode(SPI_CJ125_MOSI_PORT, SPI_CJ125_MOSI_PIN,
        LL_GPIO_MODE_ALTERNATE);
    LL_GPIO_SetAFPin_0_7(SPI_CJ125_MOSI_PORT, SPI_CJ125_MOSI_PIN, LL_GPIO_AF_5);
